    ...
    <div className="w-full bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-950 min-h-screen">
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-1">Wing Choke Valve US001</h2>
            <p className="text-sm text-gray-500 dark:text-gray-400">Level 6 Asset</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
          <StatCard title="Total CO₂e" value="120 t" change="2.1% vs target" icon={<Cloud className="w-5 h-5 text-blue-500" />} positive borderColor="border-blue-500" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          <div className="bg-gradient-to-br from-blue-100 to-blue-50 dark:from-blue-900 dark:to-blue-800 border-l-4 border-blue-500 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1">
            ...
            <div className="text-5xl font-extrabold text-blue-900 dark:text-blue-100 tracking-tight">120</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <BreakdownCard title="Gas Emissions Breakdown" items={[
            { label: "CO2", value: "80", percentage: "66.7%", color: "bg-blue-600" },
            { label: "CH4", value: "35", percentage: "29.2%", color: "bg-orange-500" },
            { label: "N2O", value: "5", percentage: "4.2%", color: "bg-purple-500" },
          ]} />
          <BreakdownCard title="Emission Sources" items={[
            { label: "Combustion", value: "50", percentage: "41.7%", color: "bg-red-500" },
            { label: "Venting", value: "40", percentage: "33.3%", color: "bg-yellow-400" },
            { label: "Flaring", value: "20", percentage: "16.7%", color: "bg-pink-400" },
            { label: "Fugitive", value: "10", percentage: "8.3%", color: "bg-green-500" },
          ]} />
        </div>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow overflow-hidden">
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full text-sm">
              <thead className="bg-gray-50 dark:bg-gray-800 border-b text-gray-600 dark:text-gray-300 text-left">
                <tr>
              ...
              <tbody>
                <tr className="border-b hover:bg-gray-50 dark:hover:bg-gray-800">
                  <td className="px-5 py-3 flex items-center gap-2">
                    <span className="text-blue-600 dark:text-blue-400">📁</span> Actuator US001
                  </td>
                  <td className="px-5 py-3">7</td>
                  <td className="px-5 py-3">40</td>
                  <td className="px-5 py-3">100.0%</td>
                  <td className="px-5 py-3">
                    <span className="bg-red-100 dark:bg-red-800 text-red-700 dark:text-red-300 px-2 py-1 rounded-full text-xs font-medium">
                      Alert
                    </span>
                  </td>
                  <td className="px-5 py-3">
                    <button className="text-blue-600 dark:text-blue-300 hover:underline flex items-center gap-1">
                      🔍 Drill Down
...
export default WingChokeValveUS001;
