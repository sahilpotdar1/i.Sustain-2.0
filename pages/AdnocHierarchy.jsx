    ...
    <div className="w-full bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 min-h-screen text-gray-900 dark:text-gray-100">
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-1">ADNOC</h2>
            <p className="text-sm text-gray-500 dark:text-gray-400">Level 1 Asset</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
          <StatCard title="Total CO₂e" value="5000 t" change="2.1% vs target" icon={<Cloud className="w-5 h-5 text-blue-500" />} positive borderColor="border-blue-500" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          <div className="bg-gradient-to-br from-blue-100 to-blue-50 dark:from-blue-900 dark:to-blue-800 border-l-4 border-blue-500 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1">
            <div className="flex items-center gap-2 text-base text-blue-800 dark:text-blue-300 font-semibold mb-1 uppercase tracking-wide">
              <Cloud className="w-4 h-4" /> Scope 1
            </div>
            <div className="text-sm text-blue-600 dark:text-blue-200 mb-2">Direct Emissions</div>
            <div className="text-5xl font-extrabold text-blue-900 dark:text-blue-100 tracking-tight">5000</div>
          ...
          <div className="bg-gradient-to-br from-green-100 to-green-50 dark:from-green-900 dark:to-green-800 border-l-4 border-green-500 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1 flex items-center justify-between">
            <div>
              <div className="flex items-center gap-2 text-base text-green-800 dark:text-green-300 font-semibold mb-2 uppercase tracking-wide">
                <CheckCircle2 className="w-4 h-4" /> Compliance Status
              </div>
        ...
        {/* Emission breakdown and sources */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <BreakdownCard title="Gas Emissions Breakdown" items={[
            { label: "CO2", value: "3500", percentage: "70%", color: "bg-blue-600" },
            { label: "CH4", value: "1000", percentage: "20%", color: "bg-orange-400" },
            { label: "N2O", value: "500", percentage: "10%", color: "bg-purple-400" },
          ]} />
          <BreakdownCard title="Emission Sources" items={[
            { label: "Combustion", value: "3200", percentage: "64%", color: "bg-red-500" },
            { label: "Venting", value: "1200", percentage: "24%", color: "bg-yellow-400" },
            { label: "Flaring", value: "400", percentage: "8%", color: "bg-pink-400" },
            { label: "Fugitive", value: "200", percentage: "4%", color: "bg-green-500" },
          ]} />
        </div>
              ...
              <tbody>
                <tr className="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800">
                  <td className="px-5 py-3 flex items-center gap-2">
                    <span className="text-blue-600">📁</span> ADNOC Offshore
                  </td>
                  <td className="px-5 py-3">2</td>
                  <td className="px-5 py-3">3200</td>
                  <td className="px-5 py-3">100.0%</td>
                  <td className="px-5 py-3">
                    <span className="bg-yellow-100 dark:bg-yellow-700 text-yellow-800 dark:text-yellow-100 px-2 py-1 rounded-full text-xs font-medium">
                      Warning
                    </span>
                  </td>
                  <td className="px-5 py-3">
                    <button onClick={() => navigate("/AdnocOffshoreHierarchy")} className="text-blue-600 dark:text-blue-400 hover:underline flex items-center gap-1">
                      🔍 Drill Down
