...
const WellHeadUS001 = () => {
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 transition-colors">
      <AdnocTopHeader />
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-1">Well Head US001</h2>
            <p className="text-sm text-gray-500 dark:text-gray-300">Level 5 Asset</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
          <StatCard title="Total CO₂e" value="300 t" change="2.1% vs target" icon={<Cloud className="w-5 h-5 text-blue-500" />} positive borderColor="border-blue-500" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          <div className="bg-gradient-to-br from-blue-100 to-blue-50 dark:from-blue-900 dark:to-blue-800 border-l-4 border-blue-500 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1">
            ...
            <div className="text-5xl font-extrabold text-blue-900 dark:text-blue-100 tracking-tight">300</div>
        ...
        {/* Breakdown + Emission Sources */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <BreakdownCard title="Gas Emissions Breakdown" items={[
            { label: "CO2", value: "200", percentage: "66.7%", color: "bg-blue-600" },
            { label: "CH4", value: "80", percentage: "26.7%", color: "bg-orange-500" },
            { label: "N2O", value: "20", percentage: "6.7%", color: "bg-purple-500" },
          ]} />
          <BreakdownCard title="Emission Sources" items={[
            { label: "Combustion", value: "150", percentage: "50.0%", color: "bg-red-500" },
            { label: "Venting", value: "100", percentage: "33.3%", color: "bg-yellow-400" },
            { label: "Flaring", value: "40", percentage: "13.3%", color: "bg-pink-400" },
            { label: "Fugitive", value: "10", percentage: "3.3%", color: "bg-green-500" },
          ]} />
        </div>
              ...
              <tbody>
                <tr className="border-b hover:bg-gray-50 dark:hover:bg-gray-700">
                  <td className="px-5 py-3 flex items-center gap-2 text-gray-800 dark:text-gray-200">
                    <span className="text-blue-600">📁</span> Wing Choke Valve US001
                  </td>
                  <td className="px-5 py-3">6</td>
                  <td className="px-5 py-3">120</td>
                  <td className="px-5 py-3">100.0%</td>
                  <td className="px-5 py-3">
                    <span className="bg-red-100 dark:bg-red-700 text-red-700 dark:text-red-100 px-2 py-1 rounded-full text-xs font-medium">
                      Alert
                    </span>
                  </td>
                  <td className="px-5 py-3">
