...
import {
  ArrowDown, ArrowUp, Flame, Leaf, Cloud, Zap,
  Settings, Download, ChevronRight, AlertTriangle, CheckCircle2,
  Search, Filter
} from "lucide-react";
...
const UmmShaifPage = () => {
  return (
    <div className="w-full bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 min-h-screen transition-colors">
      <AdnocTopHeader />
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-1">Umm Shaif Field</h2>
            <p className="text-sm text-gray-500 dark:text-gray-300">Level 3 Asset</p>
          </div>
          <div className="flex items-center gap-3">
            ...
            <button className="flex items-center gap-2 bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-200 px-4 py-2 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 shadow-md transition">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
          <StatCard title="Total CO₂e" value="1200 t" change="2.1% vs target" icon={<Cloud className="w-5 h-5 text-blue-500" />} positive borderColor="border-blue-500" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          <div className="bg-gradient-to-br from-blue-100 to-blue-50 dark:from-blue-900 dark:to-blue-800 border-l-4 border-blue-500 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1">
            ...
            <div className="text-5xl font-extrabold text-blue-900 dark:text-blue-100 tracking-tight">1200</div>
        ...
        {/* Breakdown and Emission Source */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <BreakdownCard title="Gas Emissions Breakdown" items={[
            { label: "CO2", value: "800", percentage: "66.7%", color: "bg-blue-600" },
            { label: "CH4", value: "300", percentage: "25.0%", color: "bg-orange-500" },
            { label: "N2O", value: "100", percentage: "8.3%", color: "bg-purple-500" },
          ]} />
          <BreakdownCard title="Emission Sources" items={[
            { label: "Combustion", value: "700", percentage: "58.3%", color: "bg-red-500" },
            { label: "Venting", value: "300", percentage: "25.0%", color: "bg-yellow-400" },
            { label: "Flaring", value: "150", percentage: "12.5%", color: "bg-pink-400" },
            { label: "Fugitive", value: "50", percentage: "4.2%", color: "bg-green-500" },
          ]} />
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow overflow-hidden">
          <div className="px-5 py-3 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
            <h3 className="text-base font-semibold text-gray-800 dark:text-white">Child Assets</h3>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full text-sm">
              <thead className="bg-gray-50 dark:bg-gray-700 border-b text-gray-600 dark:text-gray-300 text-left">
                <tr>
              ...
              <tbody>
                <tr className="border-b hover:bg-gray-50 dark:hover:bg-gray-700">
                  <td className="px-5 py-3 flex items-center gap-2 text-gray-800 dark:text-gray-200">
                    <span className="text-blue-600">📁</span> Oil System US001
                  </td>
                  <td className="px-5 py-3">4</td>
                  <td className="px-5 py-3">600</td>
                  <td className="px-5 py-3">100.0%</td>
                  <td className="px-5 py-3">
                    <span className="bg-yellow-100 dark:bg-yellow-700 text-yellow-800 dark:text-yellow-100 px-2 py-1 rounded-full text-xs font-medium">Warning</span>
                  </td>
                  <td className="px-5 py-3">
...
const StatCard = ({ title, value, change, icon, positive, borderColor }) => (
  <div className={`bg-white dark:bg-gray-800 shadow rounded-xl border-l-4 ${borderColor} p-5 flex items-center justify-between hover:shadow-md transition`}>
    <div>
